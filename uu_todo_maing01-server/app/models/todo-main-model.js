...
const Errors = require("../errors/todo-main-error.js");
...
class TodoMainModel {
  ...
  constructor() {
    this.validator = new Validator(Path.join(__dirname, "..", "validation-types", "todo-main-types.js"));
  }
...
module.exports = new TodoMainModel();
